<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Student_Login.aspx.cs" Inherits="Pages_Student_Login" %>
...
<body>
    ...
    <div style="height: 220px; margin-left: 150px; margin-right: 150px; margin-top: 50px;">
            <span class="auto-style3"><strong>Student Login</strong></span>
            <br />
            <br />
            ...
            <span style="font-family:'Arial Unicode MS';margin-left:100px;margin-top:50px">
                ...
                <a href="Student_Reg.aspx">Sign Up</a>
            </span>
